...
return [
    ...
    */
    ...
    'custom' => [
        'password' => [
            'password.mixed'   => 'Требуется как минимум одна заглавная и одна строчная буква',
            'password.numbers' => 'Требуется как минимум одна цифра',
        ],
        'passwordFlash' => [
            'password.mixed'         => 'Требуется как минимум одна заглавная и одна строчная буква',
            'password.numbers'       => 'Требуется как минимум одна цифра',
            'password.uncompromised' => 'Данный Пароль оказался в утечке данных. Пожалуйста, выберите другой Пароль.',
        ],
        'current_passwordFlash' => [
            'password.mixed'         => 'Требуется как минимум одна заглавная и одна строчная буква',
            'password.numbers'       => 'Требуется как минимум одна цифра',
            'password.uncompromised' => 'Данный Пароль оказался в утечке данных. Пожалуйста, выберите другой Пароль.',
        ],
    ...
    */
    ...
    'attributes' => [
        ...
        'passwordFlash'              => 'Пароль',
        'passwordFlash_confirmation' => 'Подтверждение пароля',
        'current_passwordFlash'      => 'Текущий пароль',
        'city'                       => 'Город',
        'country'                    => 'Страна',
        'address'                    => 'Адрес',
        'phone'                      => 'Телефон',
